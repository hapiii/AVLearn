...
FFMpegAccompanyDecoderController::FFMpegAccompanyDecoderController() {
...
void FFMpegAccompanyDecoderController::Init(const char* accompanyPath, const char* pcmFilePath) {
	//初始化两个decoder
...
void FFMpegAccompanyDecoderController::Decode() {
	while(true) {
...
void FFMpegAccompanyDecoderController::Destroy() {
